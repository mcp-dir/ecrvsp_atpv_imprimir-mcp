...
ECRVSP ATPV (Intenção de Venda): Imprimir segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [ecrvsp_atpv_imprimir@mcp.ai](mailto:ecrvsp_atpv_imprimir@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
